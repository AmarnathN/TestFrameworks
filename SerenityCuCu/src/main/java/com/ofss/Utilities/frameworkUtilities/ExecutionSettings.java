...
public class ExecutionSettings {
	...
	private Configuration globalVariableConfig = null;
	 ...
	 */
	public boolean isAbortForCheckpointFailureOn() {
	...
	/**
	 * Gets the global variable config.
	 *
	 * @return the global variable config
	 * @throws ConfigurationException the configuration exception
	 */
	public Configuration getGlobalVariableConfig() throws ConfigurationException {
		if (globalVariableConfig == null) {
			this.globalVariableConfig = new PropertiesConfiguration(EnvironmentVariables.getInstance().getGlobalTestDataFolderpath() + File.separator + ExecutionSettings.getUserDefinedVariableValue("GLOBALVARIABLESFILENAME"));
		}
		return globalVariableConfig;
	}
