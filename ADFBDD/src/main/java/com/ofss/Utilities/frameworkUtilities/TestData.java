...
public class TestData {
    ...
    public static Map<String, Object> runtimeData = null;
     
    public static int addRuntimeData(String runtimeVariableName, Object runtimeVariableValue){
    ...
    public static Object getRuntimeData(String runtimeVariableName){
    ...
    public static int clearRuntimeData(){
        int exitcode = ERRORCODES.DEFAULT_CODE ;
            try {
                if (runtimeData != null) {
                    runtimeData.clear();
    ...
    public static String getTestData(String testdataVariable){
    	String testdataValue = null;
            try {
            	...
            	case TDPARAMETER :
            		try {
            			Map<String,String> inputTestdataMap = (Map<String, String>) getRuntimeData("TestDataMap");
            			
		            		if(inputTestdataMap!=null && inputTestdataMap.containsKey(testdataVariable.substring(3))){
