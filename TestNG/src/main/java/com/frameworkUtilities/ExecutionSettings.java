...
public class ExecutionSettings {
	...
	public static String getApplicationURL(String applicationID) {
		...
		try {
			...
			String environmentName = ExecutionSettings.getInstance().getEnvironmentName();
